...
function Experience({ experiences }: Props) {
    return (
        <motion.div
            ...
            <div className="mt-32 md:mt-20 w-full flex space-x-5 overflow-x-scroll pb-20 md:p-10 snap-mandatory snap-x px-5 scrollbar-track-gray-400/20 scrollbar-thumb-blue-400/80 scrollbar-thin h-screen md:h-fit items-stretch">
