...
function About({ pageInfo }: Props) {
    return (
        <motion.div
            ...
            className='h-screen flex relative flex-col text-center md:text-left md:flex-row max-w-full px-10 justify-center md:justify-evenly mb-16 md:mb-0 items-center'>
